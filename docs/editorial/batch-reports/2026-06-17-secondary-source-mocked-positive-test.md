...
- **Queue-Kandidaten gesamt:** 1
- **Verwendete Candidate IDs:** rss-frostline-secondary-review
...
- **Originaltitel:** Frostline Tactics: Sekundaerquellen-Pruefung
- **Bereinigter Titel:** Frostline Tactics Update 1.2 bringt Demo und Steam-Termin
- **Entity:** Frostline Tactics
- **Entity-Typ:** game
...
- **Widersprueche:** keine
- **Unabhaengige Sekundaerquellen:** 2
- **Primaerquelle vorhanden:** nein
- **Sekundaerquellen-Fallback verwendet:** ja
- **Draft-Status:** secondary-source-review
- **Publishability-Score:** 81
- **KI-Status:** nicht gestartet (Nicht aufgerufen: Sekundaerquellen-Fallback erzeugt nur manuellen Review-Draft.)
- **Finaler Status:** secondary-source-review
- **Finaler Ablehnungsgrund:** Sekundaerquellen-Fallback genutzt. Source-Gate abgelehnt: keine verifizierte offizielle Primaerquelle; Nicht genug verifizierte Fakten fuer vollstaendigen Artikel.
...
- rss-frostline-secondary-review: Sekundaerquellen-Fallback genutzt. Source-Gate abgelehnt: keine verifizierte offizielle Primaerquelle; Nicht genug verifizierte Fakten fuer vollstaendigen Artikel.

## Steam-News-Hub-Bewertung

Keine Steam-News-Hub-Quelle bewertet.

## Entity- und Quellendiagnose

### rss-frostline-secondary-review

- **Erkannte Hauptentitaet:** Frostline Tactics
- **Entitaetstyp:** game
- **Anlass/Thementyp:** game-update
- **Entfernte Titelbestandteile:** keine
- **Verwendete Suchbegriffe:** Frostline Tactics, Frostline Tactics Steam, Frostline Tactics patch notes, Frostline Tactics official
...
- **Quellendiagnose:** Keine Steam-App nach normalisierter Spielsuche gefunden.; Mindestens zwei unabhaengige etablierte Fachmedien bestaetigen denselben Kernfakt; keine erreichbare Primaerquelle wird behauptet.
