...
const articleFields = z.object({
    ...
    heroImageCandidate: safeImageLocation.optional(),
    heroImageCandidateSourceUrl: z.string().url().optional(),
    heroImageCandidateStatus: z.literal("pending-review").optional(),
